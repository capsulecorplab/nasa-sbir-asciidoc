...
image::sample-user-EHB.png[sample user EHB, 371, align="center"]

[#ehb-system-architecture]
.EHB system architecture
image::EHB-system-architecture.png[EHB system architecture, 371, align="center"]
...
image::contract-admin-and-closeout-process-RCT.png[NASA SBIR Contract Administration and Closeout Process RCT, 371, align="center"]

[#development-matrix-rct]
.NASA SBIR Development Matrix of RCTs.
image::development-matrix-RCT.png[NASA SBIR Development Matrix of RCTs, 558, align="center"]

[#hsra-ehb-demo]
.Health Services Research Administration (HRSA) EHBs Demonstration.
image::HSRA-EHB-demonstration.png[Health Services Research Administration (HRSA) EHBs Demonstration, 371, align="center"]
...
include::potential_nasa_applications.adoc[]

==== Potential Non-NASA Applications ====

include::potential_non_nasa_applications.adoc[]
